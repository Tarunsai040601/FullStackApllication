...
const getGreeting = () => {
  ...
  if (h >= 5 && h < 12)
    return { text: "Good Morning", emoji: "👋", badge: "🌅 Morning" };
  if (h >= 12 && h < 17)
    return { text: "Good Afternoon", emoji: "☀️", badge: "☀️ Afternoon" };
  if (h >= 17 && h < 21)
    return { text: "Good Evening", emoji: "🌆", badge: "🌆 Evening" };
