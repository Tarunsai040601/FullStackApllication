...
const actions = [
  { icon: "➕", label: "Add Product", sub: "New listing", to: "/admindashboard/products" },
  { icon: "📤", label: "Upload Review", sub: "Client feedback", to: "/admindashboard/reviews" },
  { icon: "👤", label: "View Customers", sub: "All accounts", to: "/admindashboard/customers" },
  { icon: "📊", label: "Analytics", sub: "Performance", to: "/admindashboard/analytics" },
];
      ...
      <div className="stats-grid">
        {stats.map((s, i) => (
          <div className="stat-card" key={i}>
            ...
            <div className={`stat-change ${s.up ? "up" : "dn"}`}>{s.change}</div>
          </div>
        ))}
      </div>
